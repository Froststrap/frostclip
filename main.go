...
func newKVCore(inner zapcore.Core) *kvCore { return &kvCore{Core: inner} }
...
type sliceEncoder struct{ items []string }
...
func (e *sliceEncoder) AppendComplex128(v complex128) {
